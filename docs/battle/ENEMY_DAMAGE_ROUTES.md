...
`docs/battle/ENEMY_ABILITIES.md` §4 lists these damage abilities as reachable from map
...
| `docs/battle/ENEMY_ABILITIES.md` | §2 classes and carrier lists, §4 map lists |
...
1. Universe: the union of `ai.regular_ability_ids` over the 153 enemies, with
   zeros removed, restricted to the ids `docs/battle/ENEMY_ABILITIES.md` §2 classes

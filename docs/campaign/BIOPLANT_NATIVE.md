...
The subsequent [northern-crossing continuation](../field/TRAVEL.md#post-rika-northern-crossing-2026-09-23)
...
`docs/camp/PARTY_ORDER.md` records the source, targeting consequence and visual
...
canonical_record: "docs/campaign/BIOPLANT_NATIVE.md#archived-bioplant-task-graph"

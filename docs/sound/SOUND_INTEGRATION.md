...
`docs/sound/SOUND_SCOUT.md` and sourced from:
...
are recorded in `docs/battle/BATTLE_ANIMATIONS.md`.
...
| Vehicle battle music `$96` | Mounted encounter/debug battle dispatches `$96` through the existing music queue | Wired; vehicle battle surface is recorded in `docs/field/VEHICLES.md` |

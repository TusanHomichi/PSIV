...
and the disassembly notes `docs/source-notes/README.md` refers to are the topic files under
...
- `oracle/host/provenance.h` writes the paths the run *names* as basenames -
  ...
  back byte-identical
  (`docs/oracle/BATTLE_ORACLE_FORCED.md` §3a, `build/lane-evidence/group_compare/`).

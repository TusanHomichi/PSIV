...
- Zema inn rate `$068116 = 01 14`, keeper row `$0683A4`: five occupied slots
  ...
  in `../camp/SHOPS.md` and the extractor docstring. No recovery rule changed.
...
for the [legacy native/retail Y discrepancy](../camp/SAVE_SCOUT.md#native-inherited-dungeon-exit-extension-2026-09-13).
...
canonical_record: "docs/field/TRAVEL.md#archived-northern-crossing-task-graph"
...
common_inputs: ["docs/campaign/BIOPLANT_NATIVE.md#connected-rika-continuation-2026-09-23", "docs/camp/SHOPS.md", "docs/field/TRAVEL.md", "docs/DEVELOPMENT.md", "build/native-post-rika-20260923/inputs.json"]

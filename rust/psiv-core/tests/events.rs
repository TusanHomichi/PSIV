...
fn party_cast() -> Vec<ScriptedActor> {
    vec![
        ...
        ScriptedActor::new(ActorRef::PartyMember(1), Cell::new(2, 3), Direction::Down),
        ScriptedActor::new(
            ActorRef::Character(CharId(0)),
            Cell::new(2, 2),
            Direction::Down,
        ...
        ScriptedActor::new(ActorRef::Npc(0), Cell::new(4, 2), Direction::Down),
        ScriptedActor::new(ActorRef::Npc(7), Cell::new(2, 3), Direction::Down),
    ]
}
...
fn the_principal_turns_to_face_whichever_way_the_leader_came_from() {
    ...
    for (leader_facing, expected) in [
        ...
        let mut runner = SceneRunner::new(
            scene.ops,
            vec![
                ScriptedActor::new(ActorRef::PartyMember(0), Cell::new(2, 2), leader_facing),

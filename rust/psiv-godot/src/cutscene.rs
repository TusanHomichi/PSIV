...
pub(crate) struct PresentationState {
    ...
    hidden_characters: std::collections::BTreeSet<u8>,
...
impl PresentationState {
    ...
    fn create_field_object(&mut self, slot: usize, id: u16, tile: u16, x: i32, y: i32) {
    ...
    fn step_field_object(&mut self, slot: usize, step_x: i32, step_y: i32, frames: u16) {
        if let Some(object) = self.temporary_objects.get_mut(&slot)
